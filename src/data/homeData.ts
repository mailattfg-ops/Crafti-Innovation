...
export const testimonialsData = [
  ...
  },
  {
    ...
    role: "Art Enthusiast",
    content: "The level of customization and attention to detail in their handmade products is truly world-class. Each piece tells its own story."
  },
  {
    name: "Export Partner",
    role: "International Client",
    content: "Reliable, professional, and consistently high-quality. Their ability to deliver large-scale orders without compromising on craftsmanship is impressive."
  }
];
...
export const currentProjects = [
  ...
  "Bespoke Gift Collection for 2024",
  "International Import/Export Expansion"
];

export const editorialSections = [
  {
    heading: "AWARDS HONOR HARD WORK.",
    subheading: "Awards",
  ...
  {
    heading: "ELEGANCE CARVED FROM NATURE.",
  ...
  {
    heading: "RUSTIC CHARM, MODERN LIVING.",
